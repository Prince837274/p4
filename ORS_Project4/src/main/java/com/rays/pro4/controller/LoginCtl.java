...
public class LoginCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("11111111111111111111122222222");

		bean.setId(DataUtility.getLong(request.getParameter("id")));// get kiya loginctl
		System.out.println("111111111111111111111");
		bean.setLogin(DataUtility.getString(request.getParameter("login")));
		System.out.println("11111111111111111111133333333333");

		bean.setPassword(DataUtility.getString(request.getParameter("password")));
		System.out.println("111111111111111111111333333333334444444444");
